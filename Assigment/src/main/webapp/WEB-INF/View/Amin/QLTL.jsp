		...
		<div class="row">
			...
			<div class="row">
				<div class="form-group-input col-4" >
					...
					<div class="form-group-inpu col-4 mt-4"> <button class="btn btn-primary">Lọc</button> </div>
			</div>
				</form>
			</div>
		<div class="col-2"></div>
			<div class="col-4 mt-3">
				<form action="/category/indexFind" method="get">
					<div class="row">
						<div class="col-8">
				...
				<tbody>
					<c:forEach var="ca" items="${categories }">
						<tr>
							...
							<td>${ca.name }</td>
								<td>${ca.note }</td>
							<td><a href="/category/edit/${ca.id }" class="btn btn-warning" >Edit</a>
							</td>
							<td>
		...
		<div class="col-6 offset-5">
			...
			<nav aria-label="Page navigation example" >
				...
				<c:forEach var="page" begin="1" end="${pagecount }">
					...
					href="/category/index?fiel=${param.fiel == null ? 'id' : param.fiel  }&direction=${param.direction == null ? 'asc' : param.direction  }&page=${page}">${page }
					</a></li>
